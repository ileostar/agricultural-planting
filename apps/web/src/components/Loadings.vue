<script setup>
const { className } = useStore('loader')
</script>

<template>
  <main id="loading" :class="className" font-sans text="center gray-700 dark:gray-200" bg-green flex justify-center items-center relative m-0 h-full w-full>
    <div class="loader">
